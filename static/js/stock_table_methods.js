        ...
        var browseTab = {
            ...
            displayStocks : function(stockSymbols) {
                ...
                if (displayedKeys.length > 0) {
                    insertRowByValues('stocks_table', ["Symbol", "Name", "Stock Price", "Buy"]);
                    browseTab.insertRowsBySymbols(displayedKeys);
                } else {
                    insertRowByValue('stocks_table', "Nothing found, please try again.");
                }
            ...
            insertRowBySymbol : function(symbol) {
                ...
                insertRowByValues('stocks_table', [symbol, name, price, buyButton]);
